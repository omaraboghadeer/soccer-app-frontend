            ...
            <div class="container py-6 text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6">
                        <h4 class="fw-bold mb-3">Download Our Mobile APP!</h4>
                        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3">
                            @for (applink of appDownloadLinks; track $index) {
                                <a 
                                    class="card card-body bg-gray-950 text-gray-25 shadow-lg rounded" 
                                    [href]="applink.url" target="_blank" rel="noopener noreferrer">
